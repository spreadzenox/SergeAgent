...
def create_campaign(
    ...
    Args:
        ...
        channel: Canal.
        n_target: Taille (0 = pas encore posée ; `ouvrir_essai` la pose).
        budget_cap_eur: Plafond € (0 = aucun).
        window_start: Début ISO (vide = pas de fenêtre).
        window_end: Fin ISO.
        thresholds: Seuils stampés (vide = à poser avant RUN).
